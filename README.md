...
The only user interactions involve editing the cells between grid combat, scanning them as they're cloning, and healing the currently scanned cell during combat.
